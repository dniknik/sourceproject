  ...
  try {
    ...
    if(urlType == '.jpg' || urlType == '.jpeg' || urlType == '.png' || urlType == '.gif' || urlType == '.bmp'){//code to show images
      ...
      if(url.indexOf('TB_iframe') != -1){// either iframe or ajax window
          ...
          var max_window_btn = "<a href='javascript:void(0)' id='TB_resizeWindowButton' class='maximize_window'><img src='/shared/images/1x1.gif' alt='Развернуть окно' title='Развернуть окно'/></a>";

          if(params['modal'] != "true"){//iframe no modal
            $("#TB_window").append("<div id='TB_title'><div id='TB_ajaxWindowTitle'>"+caption+"</div>" + max_window_btn + "<div id='TB_closeAjaxWindow'><a href='#' id='TB_closeWindowButton' title='Закрыть окно'><img src='/shared/images/1x1.gif' alt='Закрыть окно'/></a></div></div><iframe frameborder='0' hspace='0' src='"+urlNoQuery[0]+"' id='TB_iframeContent' name='TB_iframeContent"+Math.round(Math.random()*1000)+"' onload='tb_showIframe()' style='width:"+(ajaxContentW + 29)+"px;height:"+(ajaxContentH + 17)+"px;' > </iframe>");
          }else{//iframe modal
          $("#TB_overlay").unbind();
