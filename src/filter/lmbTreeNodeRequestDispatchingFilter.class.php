...
lmb_require('src/request/lmbTreeNodeRequestDispatcher.class.php');
 ...
 * @version $Id$
 */
class lmbTreeNodeRequestDispatchingFilter extends lmbRequestDispatchingFilter
{
  function __construct($default_controller_name = 'not_found')
  {
    ...
    $dispatcher->addDispatcher(new lmbTreeNodeRequestDispatcher());
