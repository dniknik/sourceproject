...
class CategoryController extends lmbController
{
    function doRegister()
    {
        ...
        {
            $category_properties = $this->request->getPost(
                array('title', 'descr', 'identifier')
            );

            $user = new Category($category_properties);
